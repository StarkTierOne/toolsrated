...
One gap worth flagging in every generic template on this list: none of them know what you do. A blank invoice is the same blank invoice whether you are billing a kitchen remodel or a wedding shoot, so you still have to work out which lines belong on it — and the lines people forget are the ones that cost money, like the dump fee, the permit, the trip charge, or the deposit already paid. If you work in a specific trade, start from a template that already lists them: InvoiceQuick publishes [invoice templates by trade](https://invoicequick-phi.vercel.app/invoice-template) covering plumbing, electrical, HVAC, roofing, painting, cleaning, landscaping, auto repair, construction, catering, photography, and web development, each opening the generator with that trade's real billing lines already in place. You still edit the wording and set your own rates — but you are editing a checklist rather than remembering one.

A handful of those pages go further, because the trade's invoice carries lines no generic template has heard of. [Trucking and freight](https://invoicequick-phi.vercel.app/invoice-template/trucking) bills linehaul against the rate confirmation, then fuel surcharge, detention, and lumper fees. [Subcontracting](https://invoicequick-phi.vercel.app/invoice-template/subcontractor) bills schedule-of-values lines with retainage withheld and released, change orders with the approval reference, and backcharges carried rather than absorbed. [Tutoring and test prep](https://invoicequick-phi.vercel.app/invoice-template/tutoring) lists each session by student, date, and subject, shows a prepaid package as sessions used and remaining, bills a late cancellation under the signed policy, and puts a sibling discount on its own line. [Snow removal](https://invoicequick-phi.vercel.app/invoice-template/snow-removal) bills storm dates with the accumulation tier and salt by the pound; [junk removal and hauling](https://invoicequick-phi.vercel.app/invoice-template/junk-removal) bills truck-load fractions, the transfer-station fee by the ton, and the mattress and appliance surcharges. If your trade is one of those, start there.`,
    faq: [
      {
