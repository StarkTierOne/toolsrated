...
One gap worth flagging in every generic template on this list: none of them know what you do. A blank invoice is the same blank invoice whether you are billing a kitchen remodel or a wedding shoot, so you still have to work out which lines belong on it — and the lines people forget are the ones that cost money, like the dump fee, the permit, the trip charge, or the deposit already paid. If you work in a specific trade, start from a template that already lists them: InvoiceQuick publishes [invoice templates by trade](https://invoicequick-phi.vercel.app/invoice-template) covering plumbing, electrical, HVAC, roofing, painting, cleaning, landscaping, auto repair, construction, catering, photography, web development, [trucking and freight](https://invoicequick-phi.vercel.app/invoice-template/trucking) (linehaul against the rate confirmation, fuel surcharge, detention, lumper fees), [subcontracting](https://invoicequick-phi.vercel.app/invoice-template/subcontractor) (schedule-of-values lines, retainage withheld and released, change orders with the approval reference, backcharges carried rather than absorbed), and both [snow removal](https://invoicequick-phi.vercel.app/invoice-template/snow-removal) and [junk removal and hauling](https://invoicequick-phi.vercel.app/invoice-template/junk-removal), each opening the generator with that trade's real billing lines already in place. You still edit the wording and set your own rates — but you are editing a checklist rather than remembering one.`,
    faq: [
      {
